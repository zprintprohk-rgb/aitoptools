#!/usr/bin/env python3
"""Build the 2026-07-01 new tools JSON database."""
import json, os

logdir = '/f/aitoptools/.hermes/logs'

# Existing tool slugs to avoid duplication
EXISTING_SLUGS = [
...
outpath = 'F:\\aitoptools\\.hermes\\logs\\2026-07-01-new-tools.json'
with open(outpath, 'w', encoding='utf-8') as f:
    json.dump(output, f, indent=2, ensure_ascii=False)

print(f"OK: {len(new_tools)} new tools saved to {outpath}")
for t in new_tools:
    print(f"  [{t['category']}] {t['slug']} — {t['price']}")
