# -*- coding: utf-8 -*-
"""8/8 evening: IndexNow push for the new weekly CF freebie blog URL."""
...
BLOG_URLS = [
    "https://aitoptools.net/blog/best-free-creative-fabrica-assets-this-week/",
]
...
def main():
    ...
    log_line = json.dumps({"date": "2026-08-08-evening", **result}, ensure_ascii=False)
    (LOG_DIR / "indexnow-2026-08-08-evening.log").write_text(log_line + "\n", encoding="utf-8")
